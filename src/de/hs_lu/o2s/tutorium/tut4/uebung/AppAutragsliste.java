...
/**
	public static void main(String[] args) {
		Fahrzeug f1 = new Fahrzeug("Audi", "A4", "WAUZZZ8D", new Person("Peter", "Stöger"));
		Fahrzeug f2 = new Fahrzeug("Audi", "A3", "MANSU2KS", new Person("Peter", "Stöger"));
		Fahrzeug f3 = new Fahrzeug("BMW", "E90", "KALS92SA", new Person("Peter", "Stöger"));
		Fahrzeug f4 = new Fahrzeug("Mercedes", "A-Klasse", "XNBAJ28S", new Person("Jürgen", "Klopp"));
		Fahrzeug f5 = new Fahrzeug("Fiat", "Punto", "OLAMSN211", new Person("Jürgen", "Klopp"));
		...
		System.out.println("----Alle Aufträge angelegt, Auftrag 4 ----");
		System.out.println();
