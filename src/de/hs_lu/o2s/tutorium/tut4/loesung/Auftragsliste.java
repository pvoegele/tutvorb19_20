...
public class Auftragsliste {
	...
	// Entwickeln Sie eine Methode checkAktiv, die prüft, ob ein Auftrag in der Auftragsliste
	...
	public Auftrag[] checkAktiv() {
	 ...
	 // Entwickeln Sie eine Logik, die den Gesamtwert der Auftragsliste zurückgibt.
